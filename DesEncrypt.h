...
bitset<8> *Feistel(bitset<8> *RBitset, bitset<8> *NKey);		//Основная функция шифрования (функция Фейстеля)
		/*
			...
			который является результатом прео			Функция возвращает массив 32 бита
бразования 56-битового исходного ключа шифра k. 
		*/
...
bitset<8> *PermutationP(bitset<8> *SBitset);							//перестановка  P.
